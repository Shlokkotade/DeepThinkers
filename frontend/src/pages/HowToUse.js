...
const HowToUse = ({ theme }) => {
  return (
    ...
    >
      ...
      >
        Welcome to <strong>DeepThinker</strong>, your AI-powered document
          ...
          <ListItemText
            ...
            secondary={
              ...
              >
                ...
                by DeepThinker, will use the document context to provide
                tailored answers.
              </Typography>
            }
          />
      ...
      >
        DeepThinker currently supports:
      ...
      >
        DeepThinker helps you save time by summarizing long documents,
      ...
      >
        ...
        in 2025. Thank you for visiting DeepThinker! 🚀
      </Typography>
    </Box>
  );
};
