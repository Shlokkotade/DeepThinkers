    ...
    >
      ...
      <Box sx={{ maxWidth: "800px", margin: "0 auto" }}>
        ...
        <Typography variant="body1" sx={{ marginBottom: 3, font: "inherit" }}>
          By accessing and using DeepThinker, you agree to comply with and be
        ...
        <Typography variant="body1" sx={{ marginBottom: 3, font: "inherit" }}>
          DeepThinker allows users to upload, analyze, and process documents to
        ...
        <Typography variant="body1" sx={{ marginBottom: 3, font: "inherit" }}>
          You agree to use DeepThinker in compliance with all applicable laws
          ...
          rights to use them. You agree not to use DeepThinker for any unlawful
        ...
        <Typography variant="body1" sx={{ marginBottom: 3, font: "inherit" }}>
          ...
          DeepThinker at any time, without notice, if we believe that you have
        ...
        <Typography variant="body1" sx={{ marginBottom: 3, font: "inherit" }}>
          All content, features, and functionality on DeepThinker, including
          text, graphics, logos, and software, are the exclusive property of
          DeepThinker or its licensors. You may not reproduce, modify, or
        ...
        <Typography variant="body1" sx={{ marginBottom: 3, font: "inherit" }}>
          DeepThinker will not be liable for any direct, indirect, incidental,
        ...
        >
          Made with ❤️ by{" "}
          <a style={{ color: "#f57c00" }} href="https://shlokkotade.github.io/Portfolio/">
            Shlok Kotade
          </a>{" "}
          in 2024. Thank you for using DeepThinker! 🚀
        </Typography>
      </Box>
    </Box>
  );
